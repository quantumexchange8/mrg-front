    ...
    <section class="flex items-center py-6 px-0 lg:p-10 w-full lg:h-screen">
        <div class="container">
                            ...
                            <div class="absolute inset-0 bg-default-950/40">
                                <div class="flex items-end justify-center h-full">
                                    <div class="p-6 text-start">
                                        ...
                                        <p class="text-base font-medium text-default-400">Try all paid functions for free.
                            ...
                            <form action="#" class="text-start">
                                ...
                                <div class="mb-6">
                                    <div class="flex flex-wrap items-center justify-between gap-y-1">
                                        ...
                                        <a href="auth-forgotpw.html"
                                            class="text-default-200 border-b border-dashed"><small>Forgot your
                                                password?</small></a>
                                    </div>
                                </div>
                                <!-- end checkbox input -->
                                <div class="mb-6 text-center">
                                    <button
                                        ...
                                        type="submit"><span class="fw-bold">Login</span> </button>
                                </div>
                            </form><!-- end form-->
                        </div>
                        <div>
            ...
            <div class="w-full text-center mt-5">
                <p class="text-default-300 leading-6 text-base font-medium">Don't have an account? <a
                        href="auth-register.html" class="text-primary font-semibold ms-1">Sign Up</a></p>
            </div>
        </div><!-- end container -->
    </section><!-- end section -->
@endsection
